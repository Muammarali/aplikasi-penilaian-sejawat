      ...
      <div className="min-w-96 space-y-4">
        ...
        <div className="relative flex-grow">
          <input
            ...
            className="w-full p-2 pl-3 pr-10 border border-gray-300 rounded-md focus:ring-1 focus:ring-emerald-600 focus:border-emerald-600 focus:outline-none"
        ...
        <div className="space-y-2 pt-2">
          <div className="grid grid-cols-[2fr_3fr_1fr_1fr_1fr_1fr] gap-4 px-4 py-3 bg-emerald-600 rounded-md font-semibold text-zinc-100 text-sm">
